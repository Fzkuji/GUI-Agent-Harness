#!/usr/bin/env python3
"""Claude 通道复刻探针 v2:displayed 空间作答,代码乘回原图。
...
输出: runs/sspro_baseline/claude47_ccstyle_disp.jsonl
"""
...
def main():
    ...
    out_path = OUT / "claude47_ccstyle_disp.jsonl"
    done = set()
    if out_path.exists():
    ...
    print("[claude CC-disp direct] %d/%d = %.0f%% (err=%d)  [原图30%% CC协议44%% CLI 68%%]"
