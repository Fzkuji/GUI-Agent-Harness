...
| Claude 4.7 · harness | 300 | 78.0 | 75.0 | 92.0 | 62.5 | 91.9 | 71.4 | 92.6 | 72.7 | 100.0 | 84.6 | 100.0 | 50.0 | 91.3 | 68.4 | **82.3** |
...
| Claude 4.7 · harness | 91.3 | 68.4 | **+22.9** |
...
- **Harness lifts icons much more than text**, because zoom is what makes a small icon legible: e.g. Claude icon 38.9 (single) → 68.4 (harness), +29.5; GPT icon 63.4 → 77.8. But M3's icon barely moves (9.4 → 15.9): magnification alone can't fix a model that doesn't visually parse icons — its ceiling is low.
- **Claude single-shot icon is only 38.9%** — the CC-protocol 2000px downscale blurs small icons; harness zoom recovers most of it (→68.4). This is the same resolution-bottleneck story as the ablation's −adaptive column.
